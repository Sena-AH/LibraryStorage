...
public class Manage  { // Manager tolkar vad du vill gÃ¶ra och startar funktion i libraryklassen.
	...
	public static void printBook(String input) {
			...
			//lÃ¤sa av arraylist som lÃ¤ser av fil och printar innehÃ¥ll till konsoll
	...
	//	}
		// Anvï¿½nda customerobjektet nedan och anvï¿½nda det hï¿½r uppe! Hur gï¿½r man utan att kopiera och klistra in?
